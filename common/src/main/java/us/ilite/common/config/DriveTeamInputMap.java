...
public class DriveTeamInputMap {
    ...
    OPERATOR_MIDDLE_POSITION_ELEVATOR = ELogitech310.B_BTN,
    OPERATOR_TOP_POSITION_ELEVATOR = ELogitech310.Y_BTN,
    OPERATOR_CONTROL_ELEVATOR = ELogitech310.COMBINED_TRIGGER_AXIS;
}
