...
public class DriveTeamInputMap {
    ...
    DRIVER_INTAKE_HANDOFF = ELogitech310.A_BTN,
    DRIVER_INTAKE_GROUND = ELogitech310.B_BTN,
    DRIVER_INTAKE_SOLENOID = ELogitech310.Y_BTN,
    DRIVER_INTAKE_STOP = ELogitech310.START,
