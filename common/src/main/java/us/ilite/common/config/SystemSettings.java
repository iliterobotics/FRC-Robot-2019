...
public class SystemSettings extends NetworkTablesConstantsBase {
    ...
    public static int kDriveCurrentLimitAmps = 39;//50;
    ...
    public static double kMaxTargetLockCrawlSpeed = 0.30;
...
//    public static double kDriveVelocity_kF = (1023.0 / 1155.0);
    ...
    // =============================================================================
    public static PIDGains kTargetAngleLockGains = new PIDGains(1.0E-3, 0.000, 1.0E-5);
