...
public class SystemSettings extends NetworkTablesConstantsBase {
    ...
    public static double kClimbModePercentThrottleReduction = 0.4;
    public static double kClimbModePercentRotateReduction = 0.3;
...
//    public static double kDriveVelocity_kF = (1023.0 / 1155.0);
    ...
    public static double kFourBarGearRatio = 300.0 / 1.0;
    public static double kFourBarPowerReduction = 0.60;
    public static double kFourBarArmLengthInches = 25.0;
