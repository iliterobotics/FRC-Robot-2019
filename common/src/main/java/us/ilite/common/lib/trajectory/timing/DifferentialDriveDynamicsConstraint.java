...
import us.ilite.common.lib.geometry.ICurvature;
import us.ilite.common.lib.geometry.IPose2d;
...
public class DifferentialDriveDynamicsConstraint<S extends IPose2d<S> & ICurvature<S>> implements TimingConstraint<S> {
    ...
    public MinMaxAcceleration getMinMaxAcceleration(S state,
        ...
        DifferentialDrive.MinMax min_max = drive_.getMinMaxAcceleration(new ChassisState(
