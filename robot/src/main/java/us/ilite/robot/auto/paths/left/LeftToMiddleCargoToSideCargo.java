...
public class LeftToMiddleCargoToSideCargo extends AutoSequence {
    ...
    public LeftToMiddleCargoToSideCargo(TrajectoryGenerator pTrajectoryGenerator, Data mData, Drive mDrive, Limelight mLimelight, VisionGyro mVisionGyro) {
    ...
    //TODO Change angle
    public static final Pose2d kLeftLeftHatchFromStart = new Pose2d(FieldElementLocations.kCargoShipMiddleLeftHatch.translateBy(new Translation2d(-RobotDimensions.kFrontToCenter, 0.0)), Rotation2d.fromDegrees(0.0));
    ...
    public static final List<Pose2d> kMiddleLeftHatchToLoadingStationPath = Arrays.asList(
            new Pose2d(kLeftLeftHatchFromStart.getTranslation(), kTurnToLoadingStationFromMiddleLeftHatch),
