...
import static us.ilite.common.config.SystemSettings.kDriveLeftRearTalonId;

public class MixedDriveHardware implements IDriveHardware {
    ...
    private final VictorSPX mLeftMiddle, mRightMiddle;
    private final CANSparkMax mLeftRear, mRightRear;
    private ControlMode mLeftControlMode, mRightControlMode;
    private NeutralMode mLeftNeutralMode, mRightNeutralMode;

    public MixedDriveHardware() {
        ...
        mLeftRear.setIdleMode(CANSparkMax.IdleMode.kCoast);
        mRightRear.setIdleMode(CANSparkMax.IdleMode.kCoast);
...
//        configureMotor(mRightRear);
    ...
    public void zero() {
        ...
        setNeutralMode(NeutralMode.Brake, mLeftMaster, mLeftMiddle);
        setNeutralMode(NeutralMode.Brake, mRightMaster, mRightMiddle);
    ...
    public void set(DriveMessage pDriveMessage) {
        ...
        mLeftNeutralMode = configForNeutralMode(mLeftNeutralMode, pDriveMessage.leftNeutralMode, mLeftMaster, mLeftMiddle);
        mRightNeutralMode = configForNeutralMode(mRightNeutralMode, pDriveMessage.rightNeutralMode, mRightMaster, mRightMiddle);
        ...
        mLeftRear.set(mLeftMaster.getMotorOutputPercent());
        mRightRear.set(mRightMaster.getMotorOutputPercent());
    }
